          ...
          !(function (r) {
            ...
            function d(e) {
              var t,
                ...
                x = [];
              for (
                e = s(e), v = e.length, t = A, n = 0, a = S, u = 0;
                u < v;
                ++u
              )
        ...
        !(function (e, n) {
          ...
          function T(e, t, n, o, i) {
            ...
            for (p.textContent = "", h = 0; (a = d[h++]); )
              if (o && ke.inArray(a, o) > -1) i && i.push(a);
                ...
                ((c = Ye(a)), (s = w(p.appendChild(a), "script")), c && C(s), n)
              )
          ...
          function L(e, t) {
            ...
            if (1 === t.nodeType) {
              ...
              We.hasData(e) &&
                ((a = We.access(e)), (s = ke.extend({}, a)), We.set(t, s));
            }
          }
          function H(e, t) {
          ...
          function P(e, t, r, o) {
            ...
            if (
              g ||
              (p > 1 && "string" == typeof h && !ye.checkClone && lt.test(h))
            )
            ...
            if (
              ...
              for (s = ke.map(w(i, "script"), D), u = s.length; f < p; f++)
                (l = i),
                  f !== d &&
                    ((l = ke.clone(l, !0, !0)),
                    u && ke.merge(s, w(l, "script"))),
                  r.call(e[f], l, f);
              if (u)
                for (
                  c = s[s.length - 1].ownerDocument, ke.map(s, O), f = 0;
                  f < u;
                  f++
                )
                  (l = s[f]),
          ...
          function Q(e, t, n) {
            ...
            for (Y(c, l.opts.specialEasing); i < a; i++)
              if ((r = Q.prefilters[i].call(l, e, c, l.opts)))
                return (
                  be(r.stop) &&
                    (ke._queueHooks(l.elem, l.opts.queue).stop =
                      r.stop.bind(r)),
                  r
                );
            return (
              ...
              ke.fx.timer(
                ke.extend(u, { elem: e, anim: l, queue: l.opts.queue })
              ),
              l
            );
          }
                    ...
                    for (t in e)
                      (r = e[t]),
                        "__proto__" !== t &&
                          ...
                          (l &&
                          r &&
                          (ke.isPlainObject(r) || (o = Array.isArray(r)))
                            ? ((n = a[t]),
                              (i =
                                o && !Array.isArray(n)
                                  ? []
            ...
            function t(e, t, n, r) {
              ...
              if (!r && (O(t), (t = t || L), P)) {
                ...
                if (
                  ...
                  if (
                    ((c = e), (p = t), 1 === h && (fe.test(e) || ce.test(e)))
                  ) {
                    for (
            ...
            function b(e) {
              for (
                ...
                if ((n = T.relative[e[s].type])) c = [h(g(c), n)];
                  ...
                  if (
                    ((n = T.filter[e[s].type].apply(null, e[s].matches)), n[$])
                  ) {
              ...
              var o = n.length > 0,
                ...
                a = function (r, a, s, u, l) {
                  ...
                  for (
                    ...
                    if (i && c) {
                      for (
                        f = 0, a || c.ownerDocument == L || (O(c), (s = !P));
                        (p = e[f++]);
            ...
            (C = t.support = {}),
                ...
                function (e) {
                  ...
                  return r != L && 9 === r.nodeType && r.documentElement
                    ? ((L = r),
                      ...
                      (C.getElementsByClassName = ye.test(
              ...
              (t.attr = function (e, t) {
                ...
                var n = T.attrHandle[t.toLowerCase()],
                  r =
                    n && G.call(T.attrHandle, t.toLowerCase())
                      ? n(e, t, !P)
                      : void 0;
                return void 0 !== r
                  ? r
                ...
                function (e, t, n, r) {
                  ...
                  if (((n = n || []), 1 === c.length)) {
                    if (
                      ...
                      if (
                        ((t = (T.find.ID(a.matches[0].replace(we, Ce), t) ||
                          [])[0]),
                        !t)
                      )
                        return n;
              ...
              function (e, t) {
                ke.fn[e] = function (n, r) {
                  ...
                  return (
                    ...
                    this.length > 1 &&
                      (He[e] || ke.uniqueSort(o), Le.test(e) && o.reverse()),
                    this.pushStack(o)
                  );
                };
              }
          ...
          (ke.fn.ready = function (e) {
            ...
            ke.extend({
              ...
              ready: function (e) {
                (e === !0 ? --ke.readyWait : ke.isReady) ||
                  ((ke.isReady = !0),
                  (e !== !0 && --ke.readyWait > 0) || Ie.resolveWith(we, [ke]));
              },
            }),
            ...
            ("loading" !== we.readyState && !we.documentElement.doScroll)
              ...
              : (we.addEventListener("DOMContentLoaded", p),
              ...
              data: function (e, t) {
                ...
                if (void 0 === e) {
                  if (
                    this.length &&
                    ((o = We.get(i)),
                    1 === i.nodeType && !Be.get(i, "hasDataAttrs"))
                  ) {
                    for (n = a.length; n--; )
                      a[n] &&
                        ((r = a[n].name),
                        0 === r.indexOf("data-") &&
                          ((r = h(r.slice(5))), m(i, r, o[r])));
              ...
              queue: function (e, t, n) {
                ...
                if (e)
                  return (
                    ...
                    n &&
                      (!r || Array.isArray(n)
                        ? (r = Be.access(e, t, ke.makeArray(n)))
                        : r.push(n)),
                    r || []
                  );
              },
          ...
          (ke.event = {
            ...
            dispatch: function (e) {
              var t,
                ...
                u = ke.event.fix(e),
                l =
                  (Be.get(this, "events") || Object.create(null))[u.type] || [],
          ...
          ke.extend({
            ...
            clone: function (e, t, n) {
              ...
              if (
                ...
                for (a = w(s), i = w(e), r = 0, o = i.length; r < o; r++)
                  H(i[r], a[r]);
              if (t)
                if (n)
                  for (
                    i = i || w(e), a = a || w(s), r = 0, o = i.length;
                    r < o;
                    r++
                  )
                    L(i[r], a[r]);
              ...
              return (
                (a = w(s, "script")),
                a.length > 0 && C(a, !u && w(e, "script")),
                s
              );
            },
            cleanData: function (e) {
              for (
                var t, n, r, o = ke.event.special, i = 0;
                void 0 !== (n = e[i]);
                i++
              )
                if (Fe(n)) {
            ...
            ke.fn.extend({
              ...
              empty: function () {
                for (var e, t = 0; null != (e = this[t]); t++)
                  1 === e.nodeType &&
                    (ke.cleanData(w(e, !1)), (e.textContent = ""));
                return this;
              },
              clone: function (e, t) {
                return (
                    ...
                    if (
                      ...
                      try {
                        for (; n < r; n++)
                          (t = this[n] || {}),
                            1 === t.nodeType &&
                              (ke.cleanData(w(t, !1)), (t.innerHTML = e));
                        t = 0;
                      } catch (e) {}
                    }
            ...
            ke.each(
              ...
              function (e, t) {
                ke.fn[e] = function (e) {
                  for (
                    var n, r = [], o = ke(e), i = o.length - 1, a = 0;
                    a <= i;
                    a++
                  )
                ...
                return (
                  ...
                  this.each(function () {
                    ...
                    if (o) a[o] && a[o].stop && r(a[o]);
                      ...
                      for (o in a) a[o] && a[o].stop && jt.test(o) && r(a[o]);
                    for (o = i.length; o--; )
                      i[o].elem !== this ||
                        (null != e && i[o].queue !== e) ||
                ...
                select: {
                  ...
                  set: function (e, t) {
                    for (
                      ...
                      (r = o[a]),
                        (r.selected =
                          ke.inArray(ke.valHooks.option.get(r), i) > -1) &&
                          (n = !0);
            ...
            trigger: function (t, n, r, o) {
              ...
              if (
                ...
                3 !== r.nodeType &&
                  ...
                  (t = t[ke.expando]
                    ? t
                    : new ke.Event(h, "object" == typeof t && t)),
                  (t.isTrigger = o ? 2 : 3),
                  (t.namespace = g.join(".")),
          ...
          (Yt.href = Lt.href),
            ke.extend({
              ...
              ajaxSetup: function (e, t) {
                return t
                  ? oe(oe(e, ke.ajaxSettings), t)
                  : oe(ke.ajaxSettings, e);
              },
              ajaxPrefilter: ne(Kt),
              ajaxTransport: ne(Vt),
              ajax: function (t, n) {
                function r(t, n, r, s) {
                  ...
                  c ||
                    ...
                    (T.statusText = (n || C) + ""),
                    l
                      ? m.resolveWith(g, [p, C, T])
                      : m.rejectWith(g, [T, C, d]),
                    T.statusCode(b),
                    (b = void 0),
                    f &&
                ...
                (f = ke.event && h.global),
                  ...
                  h.ifModified &&
                    ...
                    ke.etag[i] &&
                      T.setRequestHeader("If-None-Match", ke.etag[i])),
          ...
          ke.ajaxSetup({
                ...
                a.length > 0 &&
                  ke
                    ...
                    .done(function (e) {
                      (i = arguments),
                        a.html(
                          r ? ke("<div>").append(ke.parseHTML(e)).find(r) : e
                        );
                    })
                    .always(
                      n &&
            ...
            ke.each(["top", "left"], function (e, t) {
              ke.cssHooks[t] = M(ye.pixelPosition, function (e, n) {
                if (n)
                  return (
                    (n = I(e, t)), ft.test(n) ? ke(e).position()[t] + "px" : n
                  );
              });
            }),
        ...
        !(function (e, n, r) {
          ...
          function f() {
            if (!m) {
              m = {};
              for (var e in y)
                (e > 95 && e < 112) || (y.hasOwnProperty(e) && (m[y[e]] = e));
            }
            return m;
          }
          function p(e, t, n) {
          ...
          function v(e) {
            ...
            function f(e, t, n, r) {
              y.stopCallback(t, t.target || t.srcElement, n, r) ||
                (e(t, n) === !1 && (u(t), l(t)));
            }
            function p(e) {
              ...
              var t = i(e);
              if (t)
                return "keyup" == e.type && w === t
                  ? void (w = !1)
                  : void y.handleKey(t, s(e), e);
            }
            function d() {
      ...
      function (e, t, n) {
        ...
        (r.prototype.parse = function (e, t, n) {
          ...
          if (!C[d] && (j || (d && !T[d]))) {
            ...
            if (!D)
              for (
                var O = this.hostname.split(/\./), S = 0, L = O.length;
                S < L;
                S++
              ) {
                var H = O[S];
    ...
    13: [
      function (e, t, n) {
        ...
        function u(e) {
          ...
          for (
            var l = 10, c = 0;
            c < l && !i.is(n) && !i.is(i.offsetParent());
            c++
          )
    ...
    16: [
      function (e, t, n) {
        ...
        function u(e) {
          ...
          if (
            (s.click(e.onClick),
            e.icon && p("<i>", { class: e.icon }).prependTo(s),
            e.dropdown)
          ) {
